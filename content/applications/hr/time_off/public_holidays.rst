...
Public holidays configured in the Time Off app are also reflected across other Odoo apps that use
:doc:`working schedules <../payroll/working_schedules>`, including **Calendar**, **Planning**,
...
- :guilabel:`End Date`: Using the date and time picker, select the date and time the holiday ends,
  ...
  .. note::
     It is recommended **not** to change the public holiday hours of `12:00 AM` to `11:59 PM` as
     this ensures all employees working all shifts receive the public holiday.

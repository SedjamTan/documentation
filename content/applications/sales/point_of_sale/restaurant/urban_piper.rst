...
Supported providers and localizations:
      ...
      .. list-table::
         ...
         * - `Just Eat <https://www.just-eat.ie/>`_
           - Austria, Belgium, Bulgaria, Canada, Denmark, Germany, Ireland, Israel, Italy,
             Luxembourg, Poland, Slovakia, Spain, Switzerland, The Netherlands, United Kingdom
         * - `Keeta <https://www.keeta-global.com/>`_
   ...
   .. tab:: Regional and national providers: Americas
      ...
      .. list-table::
         ...
         * - `SkipTheDishes <https://www.skipthedishes.com/>`_
           - Canada (Alberta, BC, Manitoba, NB, NL, NT, NS, ON, PEI, QC, SK, YT)
...
#. Set up UrbanPiper:
   ...
   #. Fill in the :guilabel:`Username` and :guilabel:`Api Key` fields with your :ref:`UrbanPiper
      credentials <urban_piper/credentials>`.
